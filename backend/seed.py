...
def seed_database():
    ...
    with app.app_context():
        print("[*] Seeding Habit Tracker Database...")
        db.create_all()
        ...
        habits_data = [
            {
                ...
                "icon": "Dumbbell",
                "reminder_time": "07:00",
                "completion_prob": 0.90, # 90% completion rate for solid streak
            },
            {
        ...
        for habit, prob in created_habits:
            for day_offset in range(28, -1, -1):
                ...
                # Ensure last 7 days are consistently done for high streaks
                if day_offset <= 7:
        ...
        # 5. Create Goals (Short-term and Long-term)
        goals_data = [
            {
        ...
        print("[USER] Demo Account: demo@habittracker.io / password123")
